...
class QRCode(Base):
    ...
    # Denormalized scan counter – incremented by Celery workers in Phase 3
    scan_count: Mapped[int] = mapped_column(Integer, default=0, nullable=False, server_default="0")
